...
class _RenderDataArmPressState extends State<RenderDataArmPress> {
  ...
  bool _postureAccordingToExercise(Map<String, List<double>> poses) {
    ...
    if (excercise == 'arm_press') {
      double wristLX = poses['leftWrist']![0];
      double wristLY = poses['leftWrist']![1];
      double wristRX = poses['rightWrist']![0];
      double wristRY = poses['rightWrist']![1];
      double elbowLX = poses['leftElbow']![0];
      double elbowRX = poses['rightElbow']![0];

      double shoulderLY = poses['leftShoulder']![1];
      double shoulderRY = poses['rightShoulder']![1];
      double kneeLY = poses['leftKnee']![1];
      double kneeRY = poses['rightKnee']![1];

      if (squatUp) {
        isCorrectPosture = wristLX > 280 &&
            elbowLX > 280 &&
            wristRX < 95 &&
            elbowRX < 95 &&
            wristLY < 240 &&
        ...
        isCorrectPosture = wristLY < 125 && wristRY < 125;
      }
    }
